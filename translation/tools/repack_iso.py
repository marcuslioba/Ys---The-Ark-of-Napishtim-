...
DST = r"C:\Users\USER\Downloads\Ys The Ark of Napishtim\translation\output\Ys - The Ark of Napishtim (PT-BR) v3.iso"

REPLACEMENTS = {
    '/PSP_GAME/USRDIR/data/movie/im03a_kaizoku_eng.srt':
        r"C:\Users\USER\Downloads\Ys The Ark of Napishtim\translation\output\movie\im03a_kaizoku_eng.srt",
    '/PSP_GAME/USRDIR/data/movie/im03b_kazaminooka_eng.srt':
        r"C:\Users\USER\Downloads\Ys The Ark of Napishtim\translation\output\movie\im03b_kazaminooka_eng.srt",
    '/PSP_GAME/USRDIR/data/arc/idm.bin':
        r"C:\Users\USER\Downloads\Ys The Ark of Napishtim\translation\output\idm_safe.bin",
}
